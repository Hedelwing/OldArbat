...
const Contacts = ({ url }) => <Layot current="Контакты" navItems={[{ name: "Главная", link: "/" }]} >
    ...
    <SEO
        title="Контакты"
        description="Контактная информация театральной студии «Старый Арбат». Как пройти до нашего театрального дома, наш номер телефона, социальные сети и другую информацию вы найдете здесь"
        url={url}
    >
