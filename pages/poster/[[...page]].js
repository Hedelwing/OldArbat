...
const Posters = ({ posters, maxPages, page, url }) => {
  ...
  return <Layot current="Афиша" navItems={[{ name: "Главная", link: "/" }]}>
    <SEO
      title="Афиша"
      description="Афиша театральной студии «Старый Арбат». Не знаете куда сходить в Москве? Приходите к нам в театр! А пока посмотрите актуальное расписание спектаклей и постановок нашего театрального дома"
      url={url}
    >
      <script
